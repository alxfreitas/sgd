...
<script>
    ...
    function showHideCombo(){
        if($('#doacaoCongregacao').attr('checked')==true){
            $('#divSemeador').hide();
            $('#divCongregacao').show();
        }else{
            $('#divCongregacao').hide();
...
<div class="fieldcontain ">
    <label for="doacaoCongregacao">
        Doação da Congregação
    </label>
    <g:checkBox name="doacaoCongregacao" id="doacaoCongregacao" onclick="showHideCombo()"/>
</div>
