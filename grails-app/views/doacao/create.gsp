		...
		<div id="create-doacao" class="content scaffold-create" role="main">
			...
			<g:form action="save" >
				...
				<fieldset class="buttons">
					<g:submitButton name="create" class="save" value="${message(code: 'default.button.create.label', default: 'Create')}"  onclick="return confirm('Confirma o lançamento da doação?')"/>
				</fieldset>
			</g:form>
		</div>
	</body>
