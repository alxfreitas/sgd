...
<div id="show-usuario" class="content scaffold-show" role="main">
    ...
    <ol class="property-list usuario">
        ...
        <g:if test="${usuarioInstance?.perfil}">
            <li class="fieldcontain">
                <span id="perfil-label" class="property-label"><g:message code="usuario.perfil.label"
                                                                          default="Perfil"/></span>

                <span class="property-value" aria-labelledby="perfil-label"><g:link controller="perfil" action="show"
                                                                                    id="${usuarioInstance?.perfil?.id}">${usuarioInstance?.perfil?.encodeAsHTML()}</g:link></span>
