			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="igreja" title="${message(code: 'igreja.igreja.label', default: 'Igreja')}" />
				...
				<g:each in="${igrejaInstanceList}" status="i" var="igrejaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${igrejaInstance.id}">${fieldValue(bean: igrejaInstance, field: "igreja")}</g:link></td>
